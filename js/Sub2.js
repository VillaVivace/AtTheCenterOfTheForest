...
Sub2.prototype = {
	create: function() {
		...
		this.tables.create(600, 355, 'atlas', 'obj_table');
		
		//shelf
		this.shelf = game.add.group();
		this.shelf.enableBody = true;
		this.shelf1 = this.shelf.create(1000, 150, 'atlas', 'obj_shelf');
		this.shelf2 = this.shelf.create(1300, 150, 'atlas', 'obj_shelf');
		...
		this.heartUI = game.add.sprite(0, 0, 'atlas', 'gui_heart');
		this.heartUI.scale.setTo(0.75, 0.75);
		this.heartUI.alpha = 0;
		this.mandrakeUI = game.add.sprite(0, 0, 'atlas', 'gui_mandrake');
		this.mandrakeUI.scale.setTo(0.75, 0.75);
		this.mandrakeUI.alpha = 0;
		this.eyeballsUI = game.add.sprite(0, 0, 'atlas', 'gui_jar');
